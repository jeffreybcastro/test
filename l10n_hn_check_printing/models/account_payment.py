...
class account_payment(models.Model):
    ...
    def do_print_checks(self):
        if self:
            ...
            if check_layout != 'disabled' and (self[0].journal_id.company_id.country_id.code == 'HN' or bool(self.env['ir.config_parameter'].sudo().get_param('account_check_printing_force_us_format'))):
